...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('account_account', (
            ('timezone', self.gf('timezones.fields.TimeZoneField')(default='Europe/London', max_length=100)),
    ...
    models = {
        'account.account': {
            ...
            'timezone': ('timezones.fields.TimeZoneField', [], {'default': "'Europe/London'", 'max_length': '100'}),
